...
CAO 2.5.0a3 ships **OAuth 2.1 + Auth0-for-MCP** support per
[`docs/rfc/cao-auth0-mcp-integration-2026-05-11-v1.md`](rfc/cao-auth0-mcp-integration-2026-05-11-v1.md).

**Default is off.** With `AUTH0_DOMAIN` unset, every CAO release before
2.5.0a3 behaves identically: localhost-only Host-header check, no auth
...
JWT scopes the HTTP mutation endpoints do (sibling RFC
[`cao-auth0-websocket-2026-05-11-v1.md`](rfc/cao-auth0-websocket-2026-05-11-v1.md)).
...
is byte-identical to 2.5.0a3 — loopback peer check only, no token
...
See the [RFC](rfc/cao-auth0-mcp-integration-2026-05-11-v1.md) §9 for
