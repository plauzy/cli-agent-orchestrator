...
mod tests {
    ...
    /// support (#573). All four are HIDE: requirements.md 16.5 forbids the surface reaching
    /// end users while the gate is closed. HANDOFF would not have satisfied that — a HANDOFF
