...
// Playwright config for the CAO MCP App E2E tier (Task 12.4, Requirement 19 E2E
// cells). The harness server (e2e/server.mjs) serves the built single-file
...
//
// Per-tier budget (Requirement 20.3): E2E < 60s per test.
