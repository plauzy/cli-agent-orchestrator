...
Ported from ``impl/cao-agent-plugins``, plus MCP-delivery properties this branch
needs and the donor could not have (it stopped at Increment 1).

Deliberately **not** ported: ``test_reachable_set_equals_the_union_for_every_provider``,
...
The one genuinely irreplaceable thing this file takes from the donor is
