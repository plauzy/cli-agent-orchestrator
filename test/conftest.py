...
that need to exercise the Auth0 paths — currently the WebSocket auth
tests in ``test/api/test_terminals.py`` (sibling RFC
``docs/rfc/cao-auth0-websocket-2026-05-11-v1.md``).
"""
