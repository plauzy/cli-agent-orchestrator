...
//
// Plugins is appended after those, for the same reason: Alt+N numbers the
// VISIBLE tabs in array order, so inserting anywhere but the end renumbers
// every shortcut after it. It is also the second conditional tab (gated on
// PLUGINS_TAB_ENABLED), so keeping both conditionals last means neither gate's
// state shifts the numbering of the always-visible tabs. (Agent Plugins, not
// the event-plugin system — see docs/agent-plugins.md.)
