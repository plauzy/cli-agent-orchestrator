...
def init_telemetry(service_name: str) -> None:
    ...
    # endpoint via PeriodicExportingMetricReader. The cache, dispatch
    # router, and ASI evaluator emit counters/gauges through the global
    # meter; when telemetry is off, the no-op meter swallows them.
